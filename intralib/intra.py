""" Intra API client from Hive with a few modifications.
"""
import os
import math
import json
...
class IntraAPIClient(object):
    ...
    def __init__(self, progress_bar=False):
        ...
        self.client_id = os.getenv("42_UID")
        self.client_secret = os.getenv("42_SECRET")
        self.token_url = os.getenv("42_URI")
        self.api_url = os.getenv("42_ENDPOINT")
        self.scopes = os.getenv("42_SCOPES")
    ...
    def request_token(self):
        ...
        res = self.request(requests.post, self.token_url,
